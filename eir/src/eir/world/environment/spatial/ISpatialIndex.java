...
//	public ISpatialSensor <K> query(ISpatialSensor <K> sensor, AABB area);
	 ...
	 * @param maxy
	 */
	public ISpatialSensor <O> queryRadius(ISpatialSensor <O> sensor, float x, float y, float radius);
	 ...
	 * @return
	 */
	public ISpatialSensor <O> queryLine(ISpatialSensor <O> sensor, float ox, float oy, float dx, double dy);
	
	
	public ISpatialSensor <O> queryAABB(ISpatialSensor <O> sensor, float cx, float cy, float dx, double dy);
